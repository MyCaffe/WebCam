...
public class DsBugWO
{
	...
	*/
	...
	public static object CreateDsInstance( ref Guid clsid, ref Guid riid )
	{
		...
		// *** QueryInterface is incrementing the reference count to 2! ***
		...
		// *** Inserted another release to decrement reference count to where it should be ***
		ct = Marshal.Release( ptrIf );
		return ooo;
	}
